...
<body>
    ...
    <!-- <input id="reloadValue" type="hidden" name="reloadValue" value="/checkouts/"> -->
                ...
                <div class="main-content" bis_skin_checked="1">
                    ...
                    <div bis_skin_checked="1">
                        <div class="section" bis_skin_checked="1">
                            <div class="section-header os-header" bis_skin_checked="1">
                                ...
                                <div class="os-header-heading" bis_skin_checked="1">
                        ...
                        <div class="thank-you-additional-content" bis_skin_checked="1">
                            Chúng tôi sẽ liên hệ với bạn để xác nhận đơn hàng, vui lòng theo dõi đơn hàng.
                        </div>
                        <div class="section thank-you-checkout-info" bis_skin_checked="1">
                            <div class="section-content" bis_skin_checked="1">
                                <div class="content-box" bis_skin_checked="1">
                                    <div class="content-box-row content-box-row-padding content-box-row-no-border" bis_skin_checked="1">
                                        <h2>Thông tin đơn hàng</h2>
                                    </div>
                                    <div class="content-box-row content-box-row-padding" bis_skin_checked="1">
                                        <div class="section-content" bis_skin_checked="1">
                                            <div class="section-content-column" bis_skin_checked="1">
                                                <h3>Thông tin giao hàng</h3>
                                                <br>
                                                Mã đơn hàng: <?= esc($ID) ?>
                                                <br>
                                                <?= esc($resOrder['customer_name']) ?>
                                                <br>
                                                <?= esc($resOrder['customer_phone']) ?>
                                                <br>
                                                <p><?= esc($resOrder['customer_address']) ?></p>
                        ...
                        <div class="step-footer" bis_skin_checked="1">
                            ...
                            <p class="step-footer-info">
                                ...
                                <span>
                                    Cần hỗ trợ? <a href="mailto:manesti.group@gmail.com">Liên hệ chúng tôi</a>
                                </span>
                            </p>
                        </div>
                    </div>
